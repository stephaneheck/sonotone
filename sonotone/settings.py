# Django settings for sonotone project.
...
SECRET_KEY = '*&)8y91v60o)o1i(uc^%4rr+il$fv0wycyne*@gr3k*v_1_+m@'
...
ROOT_URLCONF = 'sonotone.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'sonotone.wsgi.application'
...
SERVER_EMAIL = DEFAULT_FROM_EMAIL = os.environ.get('FROM_EMAIL',
                                                   "support@epyx.ch")
if DEBUG:
